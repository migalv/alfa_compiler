...
principio del fichero). Esta misma función se invocará cuando en el compilador
se declaren vectores, por eso se adjunta un argumento final (tamano) que para
esta primera práctica siempre recibirá el valor 1.
*/
...
nombre es la cadena de caracteres del operando tal y como debería aparecer en el
fuente NASM es_var indica si este operando es una variable (como por ejemplo b1)
con un 1 u otra cosa (como por ejemplo 34) con un 0. Recuerda que en el primer
...
/* FUNCIONES DE COMPARACION DE VALORES */
...
/*****************************************************************************
 * Funcion que escribe en un fichero nasm, donde pushea a la pila el valor   * 
 * de una variable que se le pasa como segundo argumento, el primer          *
 * argumento es el archivo donde se escribe                                  *
 * ***************************************************************************/
void pasarArgumentoAValor(FILE* fpasm, char* nombre);

/*****************************************************************************
 * Funcion que escribe en un fichero nasm, la llamada a una funcion con      *
 * con el nombre pasado por argumento y el numero de argumentos pasados como *
 * parametro                                                                 *
 * ***************************************************************************/
void llamarFuncion(FILE* fpasm, char* nombre, int numArgumentos);

/*****************************************************************************
 * Funcion que escribe en un fichero nasm, el inicio de una funcion con      *
 * con el nombre pasado por argumento y el numero de argumentos pasados como *
 * parametro                                                                 *
 * ***************************************************************************/
...
/*****************************************************************************
 * Funcion que escribe en un fichero nasm, el final de una funcion con       *
 * con el nombre pasado por argumento y el numero de argumentos pasados como *
 * parametro                                                                 *
 * ***************************************************************************/
